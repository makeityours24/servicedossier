...
export const dashboardDictionary = {
  nl: {
    ...
    todayAppointmentsText: "Handig om de dag te openen zonder eerst naar de volledige agenda te gaan, ook bij samengestelde bezoeken.",
    fullAgenda: "Volledige agenda",
    openInAgenda: "Open in agenda",
    noAppointments: "Er staan vandaag nog geen afspraken of samengestelde bezoeken ingepland.",
    unassigned: "Nog niet toegewezen",
    groupedVisitBadge: "Samengesteld bezoek",
    openVisit: "Open bezoek",
    groupedVisitCount: "{count} onderdeel(en)",
    status: {
      GEPLAND: "Gepland",
      VOLTOOID: "Voltooid",
  ...
  en: {
    ...
    todayAppointmentsText: "Useful for opening the day without going to the full appointment book first, including combined visits.",
    fullAgenda: "Full appointment book",
    openInAgenda: "Open in appointment book",
    noAppointments: "There are no appointments or combined visits scheduled for today yet.",
    unassigned: "Not assigned yet",
    groupedVisitBadge: "Combined visit",
    openVisit: "Open visit",
    groupedVisitCount: "{count} segment(s)",
    status: {
      GEPLAND: "Planned",
      VOLTOOID: "Completed",
  ...
  de: {
    ...
    todayAppointmentsText: "Praktisch, um den Tag zu starten, ohne zuerst ins vollständige Terminbuch zu gehen, auch bei kombinierten Besuchen.",
    fullAgenda: "Vollständiges Terminbuch",
    openInAgenda: "Im Terminbuch öffnen",
    noAppointments: "Für heute sind noch keine Termine oder kombinierten Besuche eingeplant.",
    unassigned: "Noch nicht zugewiesen",
    groupedVisitBadge: "Kombinierter Besuch",
    openVisit: "Besuch öffnen",
    groupedVisitCount: "{count} Teil(e)",
    status: {
      GEPLAND: "Geplant",
